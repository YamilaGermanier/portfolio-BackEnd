...
public class UsuarioController {
    ...
    public List<Usuario> verUsuario(){
        ...
        @GetMapping("/ver/{id}")
    @ResponseBody
    public Usuario verPUsuario(@PathVariable int id){
    ...
    public String agregarUsuario(@RequestBody Usuario user){
        ...
        return"LEl usuario fue creada correctamente";
    }
    ...
    @PutMapping("/editar")
    public String modificarUsuario(@RequestBody Usuario user, @PathVariable Integer id){
        userServ.editarUsuario(user, id);
